        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              {['About', 'Experience', 'Projects', 'Skills', 'Achievements'].map((item) => (
                <button
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:text-accent-primary transition-all duration-300 font-medium px-4 py-2 rounded-lg card-glow card-glow-hover"
                >
                  {item}
                </button>
              ))}
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={toggleTheme}
                className="text-gray-700 dark:text-gray-300 hover:text-accent-primary transition-all duration-300 p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-dark-hover card-glow card-glow-hover"
              ...
              <a
                ...
                className="text-gray-700 dark:text-gray-300 hover:text-accent-primary transition-all duration-300 p-2 rounded-lg card-glow card-glow-hover"
                aria-label="GitHub"
              >
